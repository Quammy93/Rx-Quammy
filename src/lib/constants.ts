...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "RESTful API with basic CRUD operations for a personal blogging platform",
    image: "/APIBLOGAPI.jpg",
    category: "web",
    technologies: ["React", "next.js_Backend"],
    githubUrl: "https://github.com/Quammy93/Node.js_Backend/tree/main/bloggingplatformapi",
  },
  {
    id: "4",
